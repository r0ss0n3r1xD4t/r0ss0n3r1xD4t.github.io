---
title: Ngành An Toàn Thông Tin là gì? Học xong ra trường làm gì?
...
tags:
  ...
  - tech
---
> Bài viết được fork từ [iahn.fpt.edu.vn](https://iahn.fpt.edu.vn/tin-tuc/nganh-an-toan-thong-tin-la-gi-hoc-xong-ra-truong-lam-gi) — tác giả: Son Ngo.

![Ngành An Toàn Thông Tin là gì? Học xong ra trường làm gì?](https://iahn.fpt.edu.vn/uploads/Gemini_Generated_Image_92r9kd92r9kd92r9_52d3546932.png)
...
![Untitled.png](https://iahn.fpt.edu.vn/uploads/large_Untitled_91bf69021c.png)
...
- **Người sử dụng hệ thống (user)** : chỉ những con người sử dụng hệ thống cho các tác vụ thường ngày như: khách hàng (customer) mua hàng, nhân viên bán hàng (sale) bán hàng, nhân viên kế toán (account) lập báo cáo thuế,...
...
- **Hạ tầng đám mây (cloud computing)**: cũng giống như hạ tầng & mạng thôi, nhưng nếu một công ty tự ra hàng mua server và về tự dựng một network cũng được, nhưng làm như vậy tốn một đội ngũ kỹ thuật phục vụ (gọi là IT-indoor), các ông này sẽ đảm bảo hệ thống vận hành mượt mà, có lỗi thì các ông này sẽ xử lý. Các doanh nghiệp lớn thì làm vậy ok chứ doanh nghiệp còn đang nhỏ mà bắt đi mua một đống thiết bị với thuê một đống kỹ sư IT như vậy thì chi phí không được hiệu quả (cách làm này còn gọi là on-premise). Còn một lựa chọn khác là thuê: server, network, service, application,…, cái gì cũng có thể thuê (on-cloud), tất nhiên thuê mướn có nhiều mức: thuê tất, thuê hạ tầng thôi đều được. Nhưng là gì thì cũng phải học cách sử dụng các nền tảng này, ví dụ đi thuê đồ của Microsoft thì phải biết sử dụng các công cụ của Azure, thuê của Amazon thì phải biết dùng công cụ của aws, ngoài ra còn có Google cloud với bộ gcl, ở Việt Nam cũng có rất nhiều nhà cung cấp dịch vụ cloud này nhé: FPT, Viettel, VNPT, CMC,... đều có cả. Nguyên lý giống nhau.
...
- **Tính sẵn sàng (Availability)** : các tính năng chính luôn luôn phải sẵn sàng để phục vụ vận hành. Ví dụ của tính sẵn sàng bị vi phạm: mỗi ngày của cty là 3 tỷ thông qua bán hàng online, nhưng website sập 3 ngày :D.
...
![AttackerToAssets.png](https://iahn.fpt.edu.vn/uploads/large_Attacker_To_Assets_652317902d.png)
...
![image.png](https://iahn.fpt.edu.vn/uploads/small_image_7565cbddae.png)
...
Như đã nói bức tranh HTTT rất rộng, nó kéo dài từ con người (bị lừa, bị sai), hệ thống (bị hack), quy trình (bị thao túng), phần mềm (bị lỗi), ...., thậm trí tới AI (bị đầu độc) --> có vô vàn ngành hẹp liên quan tới ngành ATTT. Bạn có thể xem qua page : [https://www.ibm.com/think/topics/cybersecurity](https://www.ibm.com/think/topics/cybersecurity) (IBM Cybersecurity topic) 😊 bạn có thể bảo tôi nói vớ vẩn chứ IBM thì ko thể vớ vẩn đâu. Tôi giúp bạn nhóm lại thành 5 nhóm (nhiều lĩnh vực có thể thuộc 2 nhóm, nên tạm thời ta ko tranh luận phần này nhé).
...
Bảng 3 – Lĩnh vực hẹp trong nhóm phát hiện và xử lý sự cố
...
Mỗi mùa tuyển sinh, câu hỏi tưởng chừng đơn giản: *"Ngành An toàn Thông tin (ATTT) học gì, ra trường làm gì?"* lại khiến không ít phụ huynh và học sinh lúng túng. Không phải vì thiếu thông tin, mà vì thông tin quá nhiều nhưng lại… khó hiểu.

Khác với Kinh tế hay Y khoa — những ngành mà chỉ cần nghe tên là hình dung được công việc — ATTT mang một đặc thù riêng: nó là ngành xây dựng trên nền tảng của một ngành khác.

> **ATTT = CNTT + An toàn**

Muốn bảo vệ một hệ thống, trước tiên bạn phải hiểu hệ thống đó hoạt động như thế nào. Tức là phải có nền tảng CNTT vững chắc: biết lập trình, hiểu mạng máy tính, nắm được cơ sở dữ liệu… rồi mới nói đến chuyện bảo vệ, phòng thủ, hay phát hiện tấn công.
...
CNTT chính là hạ tầng của hạ tầng. Tất cả các ngành nghề như thương mại, xây dựng, tài chính, y tế,… muốn vận hành trơn chu và phát triển đều cần một nền tảng hạ tầng CNTT đứng sau. Nền tảng này bao gồm:

- **Phần cứng**: máy tính PC, máy chủ, mạng máy tính
- **Phần mềm**: cơ sở dữ liệu, ứng dụng

Từ đây, ngành CNTT có rất nhiều lĩnh vực nhỏ như: kỹ thuật phần mềm, hạ tầng hệ thống, dữ liệu, v.v.

### 1.2. Hệ thống thông tin (HTTT)

HTTT thường bị nhầm với CNTT — cả hai đều nói về phần cứng + phần mềm, nhưng nhìn dưới góc độ rất khác nhau:
...
> CNTT xây ngôi nhà. HTTT đảm bảo ngôi nhà đó được xây đúng chỗ, đúng mục đích, và người dùng biết cách sử dụng.
...
Một HTTT được định nghĩa là "khỏe mạnh" khi 3 trụ cột sau được đảm bảo (gọi tắt là **CIA**):

- **Confidentiality (Tính bí mật)**: không ai được truy cập tài nguyên mà họ không được phép.
- **Integrity (Tính nhất quán)**: dữ liệu trước và sau giao dịch đều tuân thủ đúng logic.
- **Availability (Tính sẵn sàng)**: các tính năng chính luôn sẵn sàng phục vụ.

Ngoài CIA, HTTT hiện đại còn cần **Accountability** — khả năng giải trình, cho phép kiểm toán và không thể phủ nhận hành vi (non-repudiation).

Nhiệm vụ của kỹ sư ATTT: đảm bảo những điều trên cho HTTT mọi lúc, mọi nơi.

---

## 3. Bọn ATTT chúng nó học cái gì?
...
|---|---|
| Network Security | Kiểm soát và bảo vệ luồng dữ liệu ra vào hệ thống mạng |
| Endpoint Security | Bảo vệ từng thiết bị như laptop, điện thoại, server |
| Cloud Security | Đảm bảo dữ liệu và ứng dụng trên đám mây không bị lộ hay bị tấn công |
| Application Security | Tìm và vá lỗ hổng trong phần mềm trước khi hacker khai thác |
| Identity & Access Management | Đảm bảo đúng người, đúng quyền, đúng thời điểm mới được truy cập |
| Data Security & Encryption | Mã hóa và bảo vệ dữ liệu để dù bị đánh cắp cũng không đọc được |
| Critical Infrastructure Security | Bảo vệ hệ thống điện, nước, y tế, giao thông |

#### Nhóm 2 — PHÁT HIỆN & XỬ LÝ (Detect & Respond)

Không có hệ thống nào bất khả xâm phạm hoàn toàn. Theo IBM, trung bình một tổ chức mất **194 ngày** mới phát hiện ra mình đã bị xâm nhập.

| Lĩnh vực | Mô tả |
|---|---|
| SOC / SIEM / SOAR | Trung tâm giám sát 24/7, thu thập và phân tích log toàn hệ thống |
| Threat Detection & Response | Xác định mối đe dọa đang hoạt động và kích hoạt phản ứng kịp thời |
| Digital Forensics & Incident Response (DFIR) | Điều tra ngược lại sau sự cố: ai tấn công, bằng cách nào, bao giờ |
| Fraud Detection | Phát hiện hành vi gian lận tài chính, giao dịch bất thường |

#### Nhóm 3 — TẤN CÔNG CHỦ ĐỘNG HỢP PHÁP (Offensive Security)

Cách tốt nhất để biết hệ thống có lỗ hổng không là thuê người tấn công nó trước. Đây là nhóm gần nhất với hình dung "hacker mũ trắng" và cũng là một trong những hướng được trả lương cao nhất.

| Lĩnh vực | Mô tả |
|---|---|
| Penetration Testing | Kiểm thử xâm nhập có kiểm soát để tìm lỗ hổng |
| Red Teaming | Mô phỏng toàn diện một cuộc tấn công thực tế kéo dài |
| Blue Teaming | Đội phòng thủ đối trọng với Red Team |
| Ethical Hacking | Khai thác lỗ hổng hợp pháp và có đạo đức |
| Phishing Simulation | Tạo chiến dịch giả lập lừa đảo để kiểm tra nhận thức bảo mật |

> Ranh giới giữa một chân làm người hùng, một chân làm tội phạm nó mong manh cực. Bỏ qua môn đạo đức nghề nghiệp là toi đấy.

#### Nhóm 4 — TÌNH BÁO & QUẢN LÝ (Intelligence & Governance)

| Lĩnh vực | Mô tả |
|---|---|
| Threat Intelligence | Thu thập và phân tích thông tin về các mối đe dọa đang nổi |
| Threat Hunting | Chủ động đi tìm dấu hiệu tấn công tiềm ẩn trong hệ thống |
| Vulnerability Management | Liên tục rà soát và ưu tiên vá các lỗ hổng |
| Risk & Compliance | Đảm bảo tuân thủ tiêu chuẩn bảo mật (NIST, ISO 27001, CIS) |
| Cyber Insurance | Tư vấn và đánh giá rủi ro để xây dựng chiến lược bảo hiểm mạng |

#### Nhóm 5 — AN NINH THẾ HỆ MỚI (Emerging Security)

Thế giới số không đứng yên. AI tạo sinh, hệ thống OT/ICS, hàng tỷ thiết bị IoT — đây là nhóm lĩnh vực đang tăng trưởng nhanh nhất và khan hiếm chuyên gia nhất.

| Lĩnh vực | Mô tả |
|---|---|
| AI Security | Bảo vệ hệ thống AI khỏi bị tấn công, dùng AI để tăng cường phòng thủ |
| OT Security | Bảo mật hệ thống vận hành công nghiệp: nhà máy, lưới điện, giao thông |
| IoT Security | Bảo vệ hàng tỷ thiết bị thông minh kết nối mạng |

---

### 3.2. Ngành ATTT có sợ bị AI cướp việc không?

Có sợ chứ — nhưng đây là cách nhìn đúng hơn:

> AI đang trở thành phương tiện lao động mới. Nó giúp những việc trước đây KHÓ bây giờ DỄ, làm LÂU nay làm NHANH, trước đây ĐẮT nay RẺ. Điều này khiến nhiều doanh nghiệp sẵn sàng đầu tư vào HTTT hơn → nhu cầu bảo vệ các hệ thống đó cũng tăng theo.

Ngoài ra, AI có thể bị lừa, bị sai, bị hack. Giảm thiểu những rủi ro này cho hệ thống — đó là việc của kỹ sư ATTT.

> **Quan điểm cá nhân (tác giả)**: Độ hot của ATTT trong 20 năm tới chắc chắn đứng đầu trong nhóm ngành CNTT — hơn cả AI.

---

### 3.3. Người có tố chất thế nào thì phù hợp?

Không cần thiên tài. Chỉ cần hỏi bản thân: bạn có thấy hứng thú thực sự với những thứ này không?

- Tò mò về cách máy tính hoạt động từ bên trong
- Thắc mắc tin nhắn bạn gửi đi thực ra đi qua những đâu
- Có thói quen mò mẫm, nghịch ngợm hệ thống chỉ để xem nó phản ứng ra sao
- Sẵn sàng dành hàng giờ đọc tài liệu kỹ thuật vì thực sự muốn hiểu
- Gặp lỗi lạ không giải thích được, thay vì bỏ qua lại cảm thấy bị kéo vào như một câu đố

**Nhưng đam mê không phải tấm vé miễn phí.** Biết dăm ba chiêu từ YouTube, cài được Kali Linux, chạy được vài công cụ quét mạng — không phải là làm bảo mật. Ngành ATTT đòi hỏi nền tảng kiến thức bài bản từ lập trình, mạng máy tính, hệ điều hành, mật mã học… trước khi bạn thực sự hiểu mình đang làm gì.

> Người học bài bản biết **tại sao** một cuộc tấn công thành công. Người chỉ học chiêu thế chỉ biết bấm nút nào để nó chạy — và khi gặp tình huống mới, họ bó tay.
