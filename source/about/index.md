---
title: About Me
date: 2026-02-13 21:25:46
comments: false
aside: true
---

## About Me
<img src="https://img.upanh.moe/wNyw8DLm/milan-1-jpg.jpg" style="width: 300px; height: 200px; border-radius: 15px; margin: 20px 0;">

Hi, my name is Nguyen Huu Dat — also known as r0ss0n3r1. I am a first-year Information Security student at FPT University Hanoi.
...
## 📬 Connect With Me  
✉️ Email: [My email](mailto:datxmilanista@gmail.com)  
📘 Facebook: [My Facebook](https://www.facebook.com/mrdatdepzai)
💬 Discord: [My Discord](https://discord.com/users/babyovaltine)
💼 LinkedIn: [My Linkedin](https://www.linkedin.com/in/datxmilanista/)
🐱 GitHub: [My GitHub](https://github.com/r0ss0n3r1xd4t)

## 🎯 Current Focus
- CTF Competitions (Forensics Challenges)
- Vulnerability Research

## 🛠️ Skills & Tools
**Programming Languages:** Python, JavaScript, PHP, Bash
**Security Tools:** Burp Suite, OWASP ZAP, Nmap, Metasploit, SQLMap
**Web Technologies:** HTML/CSS, React, Node.js, SQL, NoSQL
**Platforms:** Linux, Windows, Docker, AWS

## 🏆 Achievements
- yah nothingtoshowyet
